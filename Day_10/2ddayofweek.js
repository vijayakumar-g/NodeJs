...
var month = +process.argv[2]; //reading the month from the user
var year = +process.argv[3]; //reading the year from the user
var y0 = Math.floor(year + 4800 - ((14 - month) / 12));
var x = Math.floor(y0 + y0 / 4 - y0 / 100 + y0 / 400);
var m0 = Math.floor(month + 12 * ((14 - month) / 12) - 3);
